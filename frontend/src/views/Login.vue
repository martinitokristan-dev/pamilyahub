    ...
    <div class="w-full max-w-sm animate-fade-in">
      ...
      <UiCard>
        <UiCardContent class="pt-6">
          ...
          <form @submit.prevent="handleEmailLogin" class="space-y-4" :class="{ 'opacity-40 pointer-events-none': googleLoading }">
            ...
            <UiButton type="submit" :disabled="emailLoading || googleLoading" class="w-full">
